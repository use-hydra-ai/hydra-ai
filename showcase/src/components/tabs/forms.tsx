      ...
      <div className="grid grid-cols-12 gap-4 w-full">
        ...
        <div className="col-span-12 md:col-span-6 p-6 border rounded-lg bg-card">
          ...
          <div className="mb-6 p-4 bg-muted/50 rounded-lg">
            <p className="text-sm text-muted-foreground">Sign in with your credentials to access:</p>
          ...
          <div className="mt-4 text-center text-sm text-muted-foreground">
            <p>Don&apos;t have an account? <span className="text-primary cursor-pointer hover:underline">Create one</span></p>
          </div>
        </div>
        ...
        <div className="col-span-12 md:col-span-6 p-6 border rounded-lg bg-card">
          ...
          />
          <div className="mt-4 text-center text-sm text-muted-foreground">
            <p>Already have an account? <span className="text-primary cursor-pointer hover:underline">Sign in</span></p>
          </div>
        </div>
            ...
            <div className="col-span-12 md:col-span-4">
              <div className="p-4 bg-muted rounded-lg mb-4">
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li>• System prompt sets the AI&apos;s behavior and context</li>
                </ul>
              </div>
