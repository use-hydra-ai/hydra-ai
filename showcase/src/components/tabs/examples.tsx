...
export function ExamplesComponent() {
  const revenueData = {
    ...
    datasets: [{
      label: 'Revenue',
      data: [14500, 16800, 15200, 17300, 16900, 18431.52, 19200, 20100, 21500, 22800, 23400, 25000],
    ...
    <main className="flex flex-col items-center gap-8 px-[12%]">
      ...
      <div className="grid grid-cols-12 gap-4 w-full">
        <div className="col-span-4 p-6 border rounded-lg bg-card">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm text-muted-foreground">+23.5% from last month</span>
            </div>
            <Graph data={revenueData} variant="default" className="h-96 mt-6 -mb-6" />
          </div>
        </div>
        ...
        <div className="col-span-4 p-6 border rounded-lg bg-card">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm text-muted-foreground">+195.3% from last month</span>
            </div>
            <Graph data={subscriptionData} variant="default" className="h-96 mt-6 -mb-6" />
          </div>
        </div>
            ...
            <div className="p-3 rounded-lg bg-muted/50 hover:bg-muted/70 cursor-pointer transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Last message 5h ago</p>
                </div>
              </div>
            </div>
            <div className="p-3 rounded-lg hover:bg-muted/50 cursor-pointer transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Last message 1d ago</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-span-3 p-6 border rounded-lg bg-card">
          ...
          <p className="text-sm text-muted-foreground">Daily activity breakdown</p>
          <Graph 
            data={activityData} 
            variant="default" 
        ...
        <div className="col-span-12 p-6 border rounded-lg bg-card mb-10">
          ...
          <Graph data={exerciseData} variant="default" className="h-96 mt-6 -mb-6" />
        </div>
      </div>
    </main>
  )
