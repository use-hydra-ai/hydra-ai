...
export function MessagesComponent() {
  ...
  useEffect(() => {
    if (isStreaming) {
      const text =
        "Let me analyze the sales data for you. Based on the trends, we can observe significant growth in Q1...";
      let index = 0;
      ...
      <div className="grid grid-cols-12 gap-4 w-full">
              ...
              <div className="flex-1">
                <ChatThread
                  messages={[
                    {
                      role: "assistant",
                      content: "I can help analyze that for you.",
                    },
        ...
        <div className="col-span-12 border rounded-lg bg-card p-6 min-h-[400px] flex flex-col">
          <h3 className="font-semibold mb-4">
            Solid Style with Typing Indicator
          </h3>
              ...
              messages={[
                {
                  role: "assistant",
                  content:
                    "I can help you with data visualization. I support multiple chart types and interactive features.",
                },
                {
                  role: "user",
                  content: "What types of charts can you generate?",
                },
              ]}
              variant="solid"
              className="h-full"
